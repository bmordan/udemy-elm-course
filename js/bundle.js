...
var _user$project$Todo$buttonStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'color', _1: 'seashell'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'backgroundColor', _1: 'DarkGoldenRod'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'border', _1: 'transparent'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'fontSize', _1: '90%'},
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Todo$listItemStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'padding', _1: '1.5rem'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'margin', _1: '0.25rem'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'backgroundColor', _1: 'DarkGoldenRod'},
				_1: {ctor: '[]'}
...
var _user$project$Todo$layoutStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background-color', _1: 'sienna'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'color', _1: 'seashell'},
			_1: {
...
var _user$project$Todo$addTask = function (model) {
...
var _user$project$Todo$notThisOne = F2(
	function (task, item) {
		return !_elm_lang$core$Native_Utils.eq(task, item);
	});
var _user$project$Todo$update = F2(
	function (msg, model) {
		var removeTask = F2(
			function (item, task) {
				return !_elm_lang$core$Native_Utils.eq(item, task);
			});
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Input':
				return _elm_lang$core$Native_Utils.update(
					...
					{task: _p0._0});
			case 'Add':
				return _user$project$Todo$addTask(model);
			case 'Done':
				var _p1 = _p0._0;
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						todo: A2(
							...
							_user$project$Todo$notThisOne(_p1),
							model.todo)
					});
			case 'Restore':
				var _p2 = _p0._0;
				return _elm_lang$core$Native_Utils.update(
					model,
					{
							...
							_elm_lang$core$List$filter,
							_user$project$Todo$notThisOne(_p2),
							model.done),
						todo: A2(
							_elm_lang$core$List$append,
							model.todo,
			...
			case 'Delete':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
							...
							_elm_lang$core$List$filter,
							_user$project$Todo$notThisOne(_p0._0),
							model.done)
					});
			default:
				return _elm_lang$core$Native_Utils.eq(_p0._0, 13) ? _user$project$Todo$addTask(model) : model;
		}
	});
var _user$project$Todo$onKeyDown = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keydown',
		A2(_elm_lang$core$Json_Decode$map, tagger, _elm_lang$html$Html_Events$keyCode));
};
var _user$project$Todo$removeFrom = F2(
	function (_p3, task) {
		var _p4 = _p3;
		return A2(_elm_lang$core$List$filter, task, _p4.todo);
	});
var _user$project$Todo$Model = F3(
	function (a, b, c) {
		return {done: a, todo: b, task: c};
	});
var _user$project$Todo$model = A3(
	_user$project$Todo$Model,
	{
		ctor: '::',
		_0: 'done',
		_1: {ctor: '[]'}
	...
	'');
var _user$project$Todo$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$Todo$Delete = function (a) {
	return {ctor: 'Delete', _0: a};
};
var _user$project$Todo$Restore = function (a) {
	return {ctor: 'Restore', _0: a};
};
var _user$project$Todo$renderDoneItem = function (item) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Todo$listItemStyle,
			_1: {
				ctor: '::',
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _justgage$tachyons_elm$Tachyons$classes(
						{
							ctor: '::',
							_0: _justgage$tachyons_elm$Tachyons_Classes$flex_auto,
							_1: {
								ctor: '::',
								_0: _justgage$tachyons_elm$Tachyons_Classes$strike,
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _justgage$tachyons_elm$Tachyons$classes(
							{
								ctor: '::',
								_0: _justgage$tachyons_elm$Tachyons_Classes$flex_none,
								_1: {
									ctor: '::',
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Todo$Restore(item)),
								_1: {
									ctor: '::',
									_0: _user$project$Todo$buttonStyle,
									_1: {
										ctor: '::',
										_0: _justgage$tachyons_elm$Tachyons$classes(
											{
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Todo$Delete(item)),
									_1: {
										ctor: '::',
										_0: _user$project$Todo$buttonStyle,
										_1: {ctor: '[]'}
...
var _user$project$Todo$renderTodoItem = function (item) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Todo$Done(item)),
			_1: {
				ctor: '::',
				_0: _user$project$Todo$listItemStyle,
				_1: {ctor: '[]'}
...
var _user$project$Todo$Input = function (a) {
...
var _user$project$Todo$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Todo$layoutStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'maxWidth', _1: '36rem'},
							_1: {
								ctor: '::',
					...
					_0: A2(
							...
							_0: _justgage$tachyons_elm$Tachyons$classes(
								{
									...
									_1: {
										ctor: '::',
										_0: _justgage$tachyons_elm$Tachyons_Classes$mt3,
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Todo$Input),
									_1: {
										ctor: '::',
										_0: _user$project$Todo$onKeyDown(_user$project$Todo$KeyDown),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.task),
											_1: {
												ctor: '::',
												_0: _justgage$tachyons_elm$Tachyons$classes(
													{
														...
														_1: {
															ctor: '::',
															_0: _justgage$tachyons_elm$Tachyons_Classes$mr3,
															_1: {
																ctor: '::',
																_0: _justgage$tachyons_elm$Tachyons_Classes$pa3,
																_1: {
																	ctor: '::',
																	_0: _justgage$tachyons_elm$Tachyons_Classes$outline_0,
																	_1: {ctor: '[]'}
																}
															}
														}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Todo$Add),
										_1: {
											ctor: '::',
											_0: _user$project$Todo$buttonStyle,
											_1: {
												...
												_0: _justgage$tachyons_elm$Tachyons$classes(
													{
														ctor: '::',
														_0: _justgage$tachyons_elm$Tachyons_Classes$ph4,
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$div,
								{ctor: '[]'},
								A2(_elm_lang$core$List$map, _user$project$Todo$renderTodoItem, model.todo)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$h2,
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										A2(_elm_lang$core$List$map, _user$project$Todo$renderDoneItem, model.done)),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Todo$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Todo$model, view: _user$project$Todo$view, update: _user$project$Todo$update})();
